...
export const mockCommunityPosts = [
  {
    ...
    liked: false,
    comments: [
      { id: 1, author: '서현짱', authorInitial: '서', authorId: 3, text: '네, 들어가십쇼.' },
      { id: 2, author: '행복킹', authorInitial: '행', authorId: 4, text: '돈 있음 ㄱㄱ' },
    ],
  ...
  },
  {
    ...
    liked: false,
    comments: [
      { id: 3, author: '응원맨', authorInitial: '응', authorId: 5, text: '화이팅입니다!' },
    ],
